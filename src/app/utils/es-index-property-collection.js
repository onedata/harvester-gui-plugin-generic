 ...
 * properties.
 *
 * @module utils/es-index-property-collection
 * @author Michał Borzęcki
 * @copyright (C) 2020 ACK CYFRONET AGH
 * @license This software is released under the MIT license cited in 'LICENSE.txt'.
 */

export default class EsIndexPropertyCollection {
  /**
   * Property name -> Utils/EsIndexProperty
   * @type {Object}
   */
  properties = {};
   ...
   * be implemented here directly - EsIndexProperty extends EsIndexPropertyCollection
   * and importing EsIndexProperty here would create an import loop.
   * @virtual
   * @param {String} name
